...
class Salooncards extends StatefulWidget {
  @override
  _SalooncardsState createState() => _SalooncardsState();
}

class _SalooncardsState extends State<Salooncards> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        children: <Widget>[
          ...
          selectedReservation !=null ? Padding(
