...
class UserChangeUsername extends StatefulWidget {
  @override
  _UserChangeUsernameState createState() => _UserChangeUsernameState();
}

class _UserChangeUsernameState extends State<UserChangeUsername> {
