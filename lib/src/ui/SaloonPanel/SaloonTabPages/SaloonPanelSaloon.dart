...
class SaloonPanelSaloons extends StatefulWidget {
  @override
  _SaloonPanelSaloonsState createState() => _SaloonPanelSaloonsState();
}

class _SaloonPanelSaloonsState extends State<SaloonPanelSaloons> {
